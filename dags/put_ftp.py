...
put_test_file = SFTPOperator(task_id='test_sftp', ssh_conn_id='COOP_SFTP_PROD', local_filepath='./staging/xiao.txt', remote_filepath='/xiao.txt', operation='PUT', dag=dag)
